...
!_ ================================================================================================================================
  ...
  SUBROUTINE control_initialize
    ...
    WRITE(numout,*) "Netcdf restart compression is : ", nc_restart_compression
    ...
    WRITE(numout,*) 'CN ratio is reset: ',reset_impose_cn  
    !
    ...
    WRITE(numout,*) 'CN ratio is read: ',read_cn  
    !
    !Config Key   = MANURE_ORGA
    !Config Desc  = Manure goes into litter pools, not mineral nitrogen pools
    !Config If    = OK_NCYCLE
    !Config Def   = n 
    !Config Help  = 
    !Config Units = [FLAG] 
    ! 
    manure_orga = .FALSE. 
    CALL getin_p('MANURE_ORGA',manure_orga) 
    WRITE(numout,*) 'Manure_orga is ',manure_orga 
