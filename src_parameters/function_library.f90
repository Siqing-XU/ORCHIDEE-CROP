...
!_ ================================================================================================================================
 ...
 !! 0. Variable and parameter declaration
    ...
    REAL(r_std)                                            :: wood_to_ba        !! Basal area of an individual tree within a circ
                                                                                 !! class @tex $(m^{2} ind^{-1})$ @endtex
...
!_ ================================================================================================================================
 ...
 !! 0. Variable and parameter declaration
    ...
    INTEGER(i_std)                             :: pft               !! PFT number (-)
    REAL(r_std), DIMENSION(nparts)       :: biomass_temp      !! Biomass of the leaves @tex $(gC m^{-2})$ @endtex
...
! to TEST_STICS
    REAL(r_std), DIMENSION(npts)                            :: intermediate_value!! Leaf area index
    REAL(r_std), DIMENSION(npts)                            :: log_value !!Leaf area index
    REAL(r_std), DIMENSION(npts)                            :: resultt !! Leaf area index
    REAL(r_std), DIMENSION(npts)                            :: resTest1 !! Leaf area index 
!_ ================================================================================================================================
...
!_ ================================================================================================================================
    ...
    !! 1. Calculate the LAI from the leaf biomass
    IF(sla_dyn) THEN
       lai_to_biomass_0d = ( exp(lai*ext_coeff_N(pft)) - 1.) / &
...
!_ ================================================================================================================================
    ...
    IF(sla_dyn) THEN
       lai_to_biomass_1d = ( exp(lai*ext_coeff_N(pft)) - 1.) / &
               (ext_coeff_N(pft) * slainit(pft))       
    ELSE
