...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.fr/orchidee/perso/mojtaba.houballah/ORCHIDEE_3/ORCHIDEE/src_sechiba/condveg.f90 $
...
!_ ================================================================================================================================
  ...
  SUBROUTINE condveg_frac_snow(kjpindex, snow_nobio, snowrho, snowdz, &
    ...
    !! 0.3 Local variables
    REAL(r_std), DIMENSION(kjpindex)                    :: snowrho_ave     !! Average snow density (Kg/m^3)
    REAL(r_std), DIMENSION(kjpindex)                    :: snowdepth       !! Snow depth
    REAL(r_std), DIMENSION(kjpindex)                    :: snowrho_snowdz       !! Snow rho time snowdz (Kg/m^3)
    INTEGER(i_std)                                      :: jv
