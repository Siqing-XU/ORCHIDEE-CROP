...
!    WRITE(flux_insec,'("ave(X*",F12.10,")")') un/dt
    ...
    IF (is_omp_root) THEN
       ...
       IF ( .NOT. almaoutput ) THEN
          ...
          IF ( ok_stomate ) THEN
             CALL histdef(hist_id, 'co2_flux', 'Net CO2 flux', 'kgC/m^2/s', &
             ...
             CALL histdef(hist_id, 'growth_resp', 'Growth respiration', 'gC/m^2/s', &
                  & iim,jjm, hori_id, nvm, 1, nvm, vegax_id, 32, fluxop_scinsec(4), dt,dw)
            CALL histdef(hist_id, 'excess_resp', 'Excess respiration', 'gC/m^2/s', &
                  & iim,jjm, hori_id, nvm, 1, nvm, vegax_id, 32, fluxop_scinsec(4), dt,dw)
       ...
       IF (is_omp_root) THEN
          IF ( .NOT. almaoutput ) THEN
            ...
            CALL histdef(hist2_id, 'alb_vis', 'Albedo visible', '1', &
             ...
             IF ( ok_stomate ) THEN
                CALL histdef(hist2_id, 'co2_flux', 'Net CO2 flux', 'kgC/m^2/s', &
                ...
                CALL histdef(hist2_id, 'growth_resp', 'Growth respiration', 'gC/m^2/s', &
                     & iim,jjm, hori_id2, nvm, 1, nvm, vegax_id2, 32, fluxop_scinsec2(6), dt, dw2)
               CALL histdef(hist2_id, 'excess_resp', 'Excess respiration', 'gC/m^2/s', &
                     & iim,jjm, hori_id2, nvm, 1, nvm, vegax_id2, 32, fluxop_scinsec2(6), dt, dw2)
  ...
  SUBROUTINE ioipslctrl_histstom( &
    ...
    IF (is_omp_root) THEN
       DO l=1,nelements 
          ...
          ! agriculure product
          CALL histdef (hist_id_stom, &
             &               TRIM("HARVEST_ABOVE       ")//TRIM(element_str(l)), &
       ...
       IF (ok_dgvm) THEN
          ...
          CALL histdef (hist_id_stom, &
               &               TRIM("tRESP_EXCESS         "), &
               &               TRIM("total resp excess of 13 PFTs (after adjustment)   "), &
               &               TRIM("gC/m^2/day          "), iim,jjm, hist_hori_id, &
               &               1,1,1, -99,32, ave(1), dt, hist_dt)
...
!_ ================================================================================================================================
  SUBROUTINE ioipslctrl_histstomipcc( &
    ...
    ! Excess Autotrophic Respiration
    CALL histdef (hist_id_stom_IPCC, &
         &               TRIM("rExcess"), &
         &               TRIM("Excess Autotrophic Respiration"), &
         &               TRIM("kg C m-2 s-1"), iim,jjm, hist_hori_id, &
         &               1,1,1, -99,32, ave(1), dt, hist_dt)
