...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.fr/orchidee/perso/mojtaba.houballah/ORCHIDEE_3/ORCHIDEE/src_sechiba/routing.f90 $
!! $Date: 2019-09-10 16:19:45 +0200 (Tue, 10 Sep 2019) $
!! $Revision: 6190 $
!! \n
!_ ================================================================================================================================
! 
...
!_ ================================================================================================================================
    ...
    IF (is_root_prc) THEN
       ...
       IF (nb_coast_gridcells == 0)THEN
          CALL ipslerr(3,'routing_initialize',&
