...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.fr/orchidee/perso/mojtaba.houballah/ORCHIDEE_3/ORCHIDEE/src_parallel/ioipsl_para.f90 $ 
!! $Date: 2020-01-29 12:46:40 +0100 (Wed, 29 Jan 2020) $
!! $Revision: 6504 $
!! \n
!_ ================================================================================================================================
...
!-
    ...
    IF (grid_type==unstructured) THEN
      ...
      IF (is_root_prc) ALLOCATE(ind_cell_glo_glo(iim_g*jjm_g))
