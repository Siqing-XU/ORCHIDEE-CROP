...
PROGRAM orchidedriver
  ...
  REAL(r_std), ALLOCATABLE, DIMENSION (:)             :: ONfert              !! N ferttilziation mojONfert
...
!!  REAL(r_std), DIMENSION(2) :: testpt=(/0.25,49.25/)
  ...
  DO itau = 1,nbdt
     ...
     CALL sechiba_main (itau_sechiba, iim*jjm, kjpindex, kindex, &
          ...
          & zlev_tq, u_tq, v_tq, qair, temp_air, epot_air, ccanopy,ONfert, &
...
!
  SUBROUTINE orchideedriver_clear
    ...
    IF ( ALLOCATED(ONfert) ) DEALLOCATE(ONfert)
